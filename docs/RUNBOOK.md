...
One marketplace row is a **series**: six invoices against the same anchor,
sharing one maturity, traded as a single lot. Open it and expand
**Series members** to show all six, each with its own invoice reference and
its holder.

> "A bank does not want six 30,000 tickets. It wants one 180,000 ticket. The
