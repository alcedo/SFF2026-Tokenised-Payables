...
- Existing-skill-first: propose `new skill via anthropic-skills:skill-creator:` only when no existing skill is a real home, the pattern recurs, and the topic deserves its own skill.
...
| <new pattern, no existing skill is a real home> | <draft a new skill via anthropic-skills:skill-creator> | <new skill via anthropic-skills:skill-creator: <kebab-name>> |
